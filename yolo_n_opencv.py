...
my_file = open("/home/carlos/Área de Trabalho/Workspace/ObjDetection/utils/coco.txt", "r")
# reading the file
data = my_file.read()
...
while True:
    ...
    if len(DP) != 0:
        for i in range(len(detect_params[0])):
            ...
            box = boxes[i]  # retorna uma caixa
            clsID = box.cls.cpu().numpy()[0]  # Aqui estamos movendo o tensor 'cls' para a CPU antes de converter para Numpy
